const announcementContent = document.querySelector('.announcements-content') as HTMLElement;
const announcementContentWrapper = document.querySelector('.announcements-content-wrapper') as HTMLElement;
const announcement=document.querySelector('.announcements') as HTMLElement;

interface announcementContentComponentInterface{
    unread:boolean;
    pa:string;
    content:string;
    course?:string;
...
function announcementContentComponent({
    ...
    attached,
    time
}:announcementContentComponentInterface):string{
