...
function cardComponent({ expired, imgSrc, imgAlt, title, subject, grade, gradeGreen, subjectDetails, classes, studentduration, gray, opacity40 }) {
    return `
    <div class="card">
                ...
                <div class="card-options">
                    <div class="views ${(opacity40 === null || opacity40 === void 0 ? void 0 : opacity40.views) ? "opacity-40" : ""}"><img src="icons/preview.svg" alt="preview"></div>
                    <div class="calendar ${(opacity40 === null || opacity40 === void 0 ? void 0 : opacity40.calendar) ? "opacity-40" : ""}"><img src="icons/manage course.svg" alt="calendar"></div>
                    <div class="grade-icon ${(opacity40 === null || opacity40 === void 0 ? void 0 : opacity40.grade) ? "opacity-40" : ""}"><img src="icons/grade submissions.svg" alt="grade submissions"></div>
                    <div class="reports ${(opacity40 === null || opacity40 === void 0 ? void 0 : opacity40.reports) ? "opacity-40" : ""}"><img src="icons/reports.svg" alt="reports"></div>
                </div>
            </div>
`;
}
